...
MONGODB_URI = os.getenv("MONGODB_URI", "mongodb+srv://juanhp324_db_user:VOF1HE1HYN3RpHde@forporeacluster.n0etmfd.mongodb.net/?retryWrites=true&w=majority&appName=ForporeaCluster")
